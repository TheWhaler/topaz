...
function onEventFinish(player, csid, option)
    ...
    elseif (csid == 508 and npcUtil.completeQuest(player, WINDURST, tpz.quest.id.windurst.AS_THICK_AS_THIEVES, {xp=3000, item=12514, var="thickAsThievesGamblingCS"})) then
